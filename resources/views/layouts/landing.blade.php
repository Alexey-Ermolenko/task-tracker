...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{ asset('landing/img/logo/landing_favicon.ico') }}"/>
    <!-- Bootstrap icons-->
...
<section class="slice py-5 slice-lg" id="services">
    <div class="container">
        <div class="row row-grid justify-content-around align-items-center">
            ...
            <div class="col-lg-6">
                <img alt="Image placeholder" src="https://via.placeholder.com/630x360.png" class="img-fluid img-center">
            </div>
        </div>
    </div>
</section>
<section class="slice py-5 slice-lg">
    <div class="container">
        <div class="row row-grid justify-content-around align-items-center">
...
<section class="py-5 border-bottom">
    <div class="container px-5 my-5 px-5">
        <div class="text-center mb-5">
            <h2 class="fw-bolder">What our customers say</h2>
            <p class="lead mb-0">
